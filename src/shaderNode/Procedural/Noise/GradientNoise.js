...
import { vec2, mul, fract, Fn, float, floor, sub, dot, mix } from 'three/tsl';

const GradientNoiseDir_dRtETCExVWxq = /*#__PURE__*/ Fn( ( [ x_immutable ] ) => {
...
const GradientNoise_dRtETCExVWxq = /*#__PURE__*/ Fn( ( [ v_immutable, Scale_immutable ] ) => {
