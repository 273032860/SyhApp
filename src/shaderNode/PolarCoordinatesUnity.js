...
import { float, vec2, uv, length,  Fn, atan } from 'three/tsl';
 ...
 */
export const polarCoordinatesUnity = /*#__PURE__*/ Fn( ( [ uv_immutable, center_immutable, radialScale_immutable, lengthScale_immutable ] ) => {
	...
	const angle = float( atan( delta.x, delta.y ).mul(float(6.28).reciprocal()).mul(lengthScale))
