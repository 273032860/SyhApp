import { float, Fn, modelWorldMatrix, modelWorldMatrixInverse, normalWorld, positionLocal, time, transformDirection, vec2, vec3, vec4 } from "three/tsl"
...
export const vegetationDeformation = Fn(([bendStrength,windDir,leafSpeed,leafSiffness,leafFrequency,leafAmplitude,branchStiffness,branchAmplitude,phaseOffset]) => {
   ...
   const magicfun3 = vec3(normalWorld.x.mul(magicfun3a),magicfun3b,normalWorld.z.mul(magicfun3a))
