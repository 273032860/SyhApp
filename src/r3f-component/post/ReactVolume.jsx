...
const ReactVolume = () => {
  ...
  useControls({
    resolution: { value: 0.25, min: 0.1, max: 0.5, step: 0.01,
    ...
    denoiseStrength: { value: 0.6, min: 0, max: 1, step: 0.1,
      onChange: (value) => uniforms.denoiseStrength.value = value
    },
    denoise: { value: true,
      onChange: (value) => {
    ...
    volumetricLightingIntensity: { value: 0.1, min: 0, max: 2, step: 0.1,
      onChange: (value) => uniforms.volumetricLightingIntensity.value = value
    },
    smokeAmount: { value: 0, min: 0, max: 4, step: 0.1,
      onChange: (value) => uniforms.smokeAmount.value = value
    },
  },{ collapsed: false });
