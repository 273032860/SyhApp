...
export const Line = function Line({ 
  ...
  const line2 = React.useMemo(() => (segments ? new LineSegments2() : new Line2()), [segments,smoothness])
  const itemSize = (vertexColors?.[0])?.length === 4 ? 4 : 3
  const lineMaterial = React.useMemo(() => new Line2NodeMaterial({vertexColors: vertexColors,dashed:dashed}),[color, lineWidth,vertexColors,dashed])
  ...
  }, [lineMaterial, worldUnits, alphaToCoverage, depthTest, transparent, opacity, visible,dashedScale,dashedSize,gapSize,dashOffset,lineWidth,itemSize])
